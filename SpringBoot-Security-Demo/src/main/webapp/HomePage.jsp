...
<head>
  <meta charset="utf-8">
  <title>Spring Boot Security WebApp</title>
...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="/homepage" class="list-group-item list-group-item-action bg-light-selected">Home Page</a>
      </div>
    </div>
    <!--########################## /#sidebar-wrapper #############################-->
...
<div id="page-content-wrapper">
	 <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
      ...
      <ul class="navbar-nav ml-auto mt-2 mt-lg-0"> 
              <h2>Spring Boot Security Demo WebApp</h2>
      </ul>			
      ...
      <div class="container-fluid">
        <h3 class="mt-4">Home Page SpringBoot Security</h3>
      </div>      
